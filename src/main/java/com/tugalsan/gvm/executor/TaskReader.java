...
public class TaskReader {
    ...
    final private static TS_Log d = TS_Log.of(false, TaskReader.class);

    public static Path pathDefault() {
        return TS_PathUtils.getPathCurrent_nio(TaskReader.class.getPackageName()+ ".properties");
    }

    private TaskReader(Path propsFile) {
        ...
        var onHandlerFile_filterUrlsWithHiddenCharsStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_onHandlerFile_filterUrlsWithHiddenChars", "true");
        ...
        var onHandlerString_removeHiddenCharsStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_onHandlerString_removeHiddenChars", "true");
        ...
        ip = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_ip", "localhost");
        d.ci("construtor", "ip", ip);

        var redirectToSSLStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_sslRedirect", "true");
        ...
        var sslPortStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_sslPort", "7443");
        ...
        var sslPathStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_sslPath", "D:/xampp_data/SSL/tomcat.p12");
        ...
        sslPass = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_sslPass", "MyPass");
        d.ci("construtor", "sslPass", sslPass);

        fileHandlerServletName = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_fileHandlerServletName", "/file/");
        d.ci("construtor", "fileHandlerServletName", fileHandlerServletName);

        var fileHandlerRootStr = TS_FilePropertiesUtils.getValue(props, TaskReader.class.getPackageName() + "_fileHandlerRoot", "D:/file");
    ...
    public static TaskReader of(Path propsFile) {
        return new TaskReader(propsFile);
    }

...
public class TaskWriter {
    ...
    final private static TS_Log d = TS_Log.of(false, TaskWriter.class);

    public static Path pathDefault() {
        return TS_PathUtils.getPathCurrent_nio(TaskWriter.class.getPackageName()+ ".properties");
    }

    private TaskWriter(Path propsFile) {
        ...
        var onHandlerFile_filterUrlsWithHiddenCharsStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_onHandlerFile_filterUrlsWithHiddenChars", "true");
        ...
        var onHandlerString_removeHiddenCharsStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_onHandlerString_removeHiddenChars", "true");
        ...
        ip = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_ip", "localhost");
        d.ci("construtor", "ip", ip);

        var redirectToSSLStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_sslRedirect", "true");
        ...
        var sslPortStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_sslPort", "7443");
        ...
        var sslPathStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_sslPath", "D:/xampp_data/SSL/tomcat.p12");
        ...
        sslPass = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_sslPass", "MyPass");
        d.ci("construtor", "sslPass", sslPass);

        fileHandlerServletName = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_fileHandlerServletName", "/file/");
        d.ci("construtor", "fileHandlerServletName", fileHandlerServletName);

        var fileHandlerRootStr = TS_FilePropertiesUtils.getValue(props, TaskWriter.class.getPackageName() + "_fileHandlerRoot", "D:/file");
    ...
    public static TaskWriter of(Path propsFile) {
        return new TaskWriter(propsFile);
    }
